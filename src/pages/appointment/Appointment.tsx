...
export default function Appointment() {
  ...
  return (
    <form className="form" onSubmit={formData.handleSubmit(onSubmit)}>
      <SelectField name={'manicureOptions'} control={formData.control} options={manicureOptions} />
      <SelectField name={'pedicureOptions'} control={formData.control} options={pedicureOptions} />
      <SelectField name={'podologyOptions'} control={formData.control} options={podologyOptions} />
