...
import { InputField, SelectField, DatepickerField, CheckboxField } from '../../components/form';
  ...
  return (
    <div className="appointment">
      <div className="appointment__wrapper">
        <form className="appointment__form" onSubmit={formData.handleSubmit(onSubmit)}>
